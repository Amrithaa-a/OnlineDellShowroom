...
$(document).ready(function () {
    ...
    function validateMobileNumber() {
        ...
        var validStartingDigits = /^[6-9]/; // Regular expression for digits 6, 7, 8, 9
        ...
        } else if (!validStartingDigits.test(mobilenumber)) {
    ...
    // Add input event listener to allow only digits
...
$(document).ready(function () {
    ...
    function getCitiesByState(stateId) {
        $.ajax({
            ...
            success: function (data) {
                // In the success function, set the hidden fields with the selected state and city names
                $('#State').val($('#StateDropdown option:selected').text());
                $('#City').val($('#CityDropdown option:selected').text());
    ...
    $('#StateId').val(selectedStateId);
    getCitiesByState(selectedStateId);
    // On form submit, update the hidden fields with the selected state and city names
...
$(document).ready(function () {
    ...
    function validateUsername() {
        ...
        if (username === "") {
            ...
            $.ajax({
                type: "POST",
                url: "/YourController/CheckUsernameExists", // Replace with the actual controller method to check username existence
...
$(document).ready(function () {
    ...
    function validateConfirmPassword() {
        ...
        if (confirmPassword === "") {
            ...
            $("#confirmPasswordError").text("Confirm password does not match the password.");
            return false;
        } else {
